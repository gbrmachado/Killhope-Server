    ...
    Public Class FTPdirectory
        ...
        Sub New(ByVal dir As String, ByVal path As String)
            For Each line As String In dir.Replace(vbLf, "").Split(CChar(vbCr))
                ...
                'Added by DavidA
                'If the content is not a file/directory, then we do not care about it and should skip it.
                'With thanks to T Poot for explanation of files and link: http://www.linuxnix.com/2010/02/file-types-in-linux.html
                Try
                    If line <> "" Then Me.Add(New FTPfileInfo(line, path))
                Catch ex As InvalidFTPObjectException
